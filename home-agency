...
4. Требования к css
   - для построения сетки используется css-flexbox, или css-grid
   ...
   - изображения добавлены в формате `.jpg` (оптимизированы)
...
4. Запрещается использование CSS-препроцессоров (`SASS`, `Less`)
